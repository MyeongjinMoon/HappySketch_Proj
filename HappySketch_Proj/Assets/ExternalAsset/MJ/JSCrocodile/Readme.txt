Thank you for downloading Crocodile.

This is a semi realistic 3d model and animations of Crocodile. 
-Models folder contains CrocodileModelLowPoly.FBX, CrocodileModelMiddlePoly.FBX, CrocodileModelTowLODs.FBX,

-Animations folder contains FBX files of animations.
Walk  animations are compatible with root motion.
-Animations/InPlace folder contains In Place variations of walk animations.
These are not used in the demo.
-Textures folder contains textures.
These are main contents of this package.

Demo folder contains an example use of the Crocodile model. 
